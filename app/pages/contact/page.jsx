            ...
            <div class="divide-y divide-gray-200 dark:divide-gray-800">
              <div class="flex gap-x-7 py-6">
                ...
                <div>
                  ...
                  <a class="mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" href="tel:+91 89100 68721">
                    Contact support
              ...
              <div class="flex gap-x-7 py-6">
                ...
                <div>
                  ...
                  <Link class="mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" href="/faq">
                    Visit FAQ
                    <svg class="w-2.5 h-2.5 transition ease-in-out group-hover:translate-x-1" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M0.975821 6.92249C0.43689 6.92249 -3.50468e-07 7.34222 -3.27835e-07 7.85999C-3.05203e-07 8.37775 0.43689 8.79749 0.975821 8.79749L12.7694 8.79748L7.60447 13.7596C7.22339 14.1257 7.22339 14.7193 7.60447 15.0854C7.98555 15.4515 8.60341 15.4515 8.98449 15.0854L15.6427 8.68862C16.1191 8.23098 16.1191 7.48899 15.6427 7.03134L8.98449 0.634573C8.60341 0.268455 7.98555 0.268456 7.60447 0.634573C7.22339 1.00069 7.22339 1.59428 7.60447 1.9604L12.7694 6.92248L0.975821 6.92249Z" fill="currentColor" />
                    </svg>
              ...
              <div class=" flex gap-x-7 py-6">
                ...
                <div>
                  <h3 class="font-semibold text-gray-800 dark:text-gray-200">Contact Sales</h3>
                  <p class="mt-1 text-sm text-gray-500">Reach out to our Sales team for personalized solutions.</p>
                  <a class="mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" href="tel:+91 89100 68721">
                    +91 89100 68721
                  </a>
                </div>
              ...
              <div class=" flex gap-x-7 py-6">
                ...
                <div>
                  ...
                  <a class="mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" href="mailto:business@easygorooms.com">
                    business@easygorooms.com
                  </a>
                </div>
              </div>
            </div>
