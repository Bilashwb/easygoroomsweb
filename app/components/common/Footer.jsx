		...
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			<div className="space-y-3">
				...
				<ul className="space-y-1 text-white">
					...
					<li>
						<Link rel="noopener noreferrer" href="/pages/contact">Contact Us</Link>
					</li>
					<li>
						<Link rel="noopener noreferrer" href="/pages/blogs">Blogs</Link>
					</li>
					<li>
						<Link rel="noopener noreferrer" href="/pages/careers">Careers</Link>
					</li>
					<li>
						<Link rel="noopener noreferrer" href="/pages/privacy">Privacy Policy</Link>
					</li>
					<li>
						<Link rel="noopener noreferrer" href="/pages/toc">Terms of Service</Link>
					</li>
				</ul>
			</div>
			<div className="space-y-3">
				...
				<ul className="space-y-1 text-white">
					...
					<li>
						<Link rel="noopener noreferrer" href="/pages/services/pms">PMS</Link>
					</li>
				</ul>
			</div>
			<div className="space-y-3 text-white">
				...
				<ul className="space-y-1">
					<li>
						<Link rel="noopener noreferrer" href="tel:+91 89100 68721">+91 89100 68721</Link>
					</li>
					<li>
					<Link href="mailto:business@easygorooms.com">business@easygorooms.com</Link>
					</li>
					<br />
