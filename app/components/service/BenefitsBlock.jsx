    ...
    <>
     <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12 mb-4">
                    ...
                    <div className="md:5/12 lg:w-5/12 wow slideInLeft"  data-wow-duration="3s">
                        ...
                        <div className="text-end my-5 flex gap-4">
                            ...
                            <Link  className="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold text-blue-500 hover:text-blue-700 focus:outline-none focus:ring-2 ring-offset-white focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm" href={'/pages/services'}>
                                Others Services
                            </Link>
                        </div>
                    </div>
