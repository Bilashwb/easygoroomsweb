...
export default function TeamCard(props) {
  ...
  return (
    ...
    <div class="flex items-center gap-x-4">
      <img class="rounded-full w-20 h-20" src={image} alt="Image Description"/>
      <div class="grow">
    ...
    <p class="mt-3 text-gray-500 text-justify">
    I am incredibly proud to be a part of the Easygorooms team! Working here has been an inspiring journey filled with growth, learning, and wonderful camaraderie.
    </p>
